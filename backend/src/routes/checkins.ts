    ...
    const rawResult = checkins.map((c) => ({
      ...
      trainingLog: c.trainingLogs.map((log) => ({
        ...
        exercises: log.exercises.map((e) => ({
          ...
          section: e.section,
          sectionExt: (e as any).sectionExt || undefined,
          ...
          plannedPace: (e as any).plannedPace ?? undefined,
          plannedHeartRate: (e as any).plannedHeartRate ?? undefined,
          plannedMarkValue: (e as any).plannedMarkValue ?? undefined,
          plannedMarkUnit: (e as any).plannedMarkUnit ?? undefined,
          // Opposition actual
          actualDistanceM: (e as any).actualDistanceM ?? undefined,
          actualDurationSec: (e as any).actualDurationSec ?? undefined,
          actualPace: (e as any).actualPace ?? undefined,
          actualHeartRate: (e as any).actualHeartRate ?? undefined,
          actualMarkValue: (e as any).actualMarkValue ?? undefined,
          actualMarkUnit: (e as any).actualMarkUnit ?? undefined,
          scoreObtained: (e as any).scoreObtained ?? undefined,
        })),
      })),
