...
import { ArrowLeft, Activity, Utensils, Dumbbell, Trophy, Brain, AlertTriangle, Search, Plus, Pencil, Trash2 } from "lucide-react";
      ...
      {selectedClient ? (
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {filtered.length === 0 && <p className="text-sm text-muted-foreground col-span-full text-center py-12">{t("progress.noClients")}</p>}
          </div>
        </div>
      )}
    </AdminLayout>
